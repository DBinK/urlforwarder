...
public class FiltersFragment extends Fragment {
    ...
    private LinkFilterStorage storage;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SQLiteOpenHelper sqliteOpenerHelper = ((UrlForwarderApplication) getActivity().getApplication()).getSqliteOpenHelper();
        DatabaseObservable databaseObservable = DatabaseObservable.getReadable(sqliteOpenerHelper);
        LinkFilterMapper linkFilterMapper = new LinkFilterMapperImpl();
        storage = new LinkFilterStorageImpl(databaseObservable, linkFilterMapper);
    }
