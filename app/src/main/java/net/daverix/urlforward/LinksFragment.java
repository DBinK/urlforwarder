...
public class LinksFragment extends ListFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseObservable database = DatabaseObservable.getReadable(((UrlForwarderApplication) getActivity()
                .getApplication())
                .getSqliteOpenHelper());
        LinkFilterMapper mapper = new LinkFilterMapperImpl();
        storage = new LinkFilterStorageImpl(database, mapper);
    }
